...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_PATH)/../common/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml
...
ifeq ($(GENERIC_ODM_IMAGE),true)
  ...
  PRODUCT_COPY_FILES += \
    $(CONFIG_PATH)/../common/media_profiles.xml:$(TARGET_COPY_OUT_ODM)/etc/media_profiles_V1_0.xml
else
